...
// the fast evaluation method for N point correlators using kt clustering
// and a jet resolution f = f' kt_min^2, with f' >0.
//
...
int main(int argc, char* argv[]){
    ...
    //Check syntax
    if (argc != 8){
        cout << "Usage: ./eec_fast_kt input_file events N resolutionfactor minbin nbins output_file\n"
        << "\n"
