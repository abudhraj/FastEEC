...
// using C/A clustering and with a constant jet resolution f > 1.
//
...
int main(int argc, char* argv[]){
    ...
    //Check syntax
    if (argc != 9){
        cout << "Usage: ./eec_fast_weight input_file events N resolutionfactor kappa minbin nbins output_file\n"
        << "\n"
